...
use linera_views::{
    ...
    memory::{create_memory_context, test_memory_store_config, MemoryContext, MemoryStore},
    queue_view::HashedQueueView,
    reentrant_collection_view::HashedReentrantCollectionView,
    register_view::HashedRegisterView,
    set_view::HashedSetView,
    test_utils::{
        self, generate_test_namespace, get_random_byte_vector, get_random_key_value_operations,
